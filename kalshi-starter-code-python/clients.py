...
class KalshiWebSocketClient(KalshiBaseClient):
    ...
    async def on_open(self, channel, market_ticker):
        ...
        await self.choose_subscription(market_ticker, channel)

    async def choose_subscription(self, market_ticker, channel="orderbook_delta"):
        #process data from this format to this format 

        subscribe_param = {"id": self.message_id,
                           "cmd": "subscribe",
                           "params": 
                                {"channels": channel, 
    ...
    async def handler(self):
        ...
        try:
            ...
            raise  # Let connect() handle reconnection
        except Exception as e:
            print(f"Handler error: {e}")
            raise    async def on_message(self, message):
